...
def work_with_matrix(args, deg_table=None, promoters=None, parameter=None, 
...
def deg_case(path_to_deg, path_to_db, output_dir, path_to_promoters, 
    ...
    with Pool(number_of_cores) as pool:
        results = pool.ThreadPoolExecutor(partial(work_with_matrix, deg_table=deg_table, promoters=promoters, parameter=parameter,
