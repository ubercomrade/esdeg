...
hocomoco_to_pwm, seq_to_int, all_scores_pwm, count_sites
...
def worker(index, motif_data, promoters, output_dir):
    ...
    pwm = hocomoco_to_pwm(motif_data)
...
def prepare_motif_db(output_dir, path_to_promoters, nproc):
    ...
    #metadata
    metadata = dict()
    metadata['db'] = 'hocomoco'
    metadata['taxon'] = 'human'
