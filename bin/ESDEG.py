...
def parse_args():
    ...
    preparation_parser.add_argument('organism', action='store', choices=['mm10', 'hg38', 'tair10', 'rnor6', 'rnor6_ucsc'], metavar='N',
         help='Promoters of organism (hg38, mm10, tair10, rnor6)')
